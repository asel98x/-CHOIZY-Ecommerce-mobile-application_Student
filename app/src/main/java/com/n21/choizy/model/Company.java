...
public class Company {
    String company_category,company_email,company_mobile,company_name,company_password,imageURL,key,companyAbout,companyFeatures
            ,companyTerms,companyDiscountRange;
